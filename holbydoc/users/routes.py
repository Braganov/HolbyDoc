...
from holbydoc.models import User, Lesson
from flask import (
    render_template,
    url_for,
    flash,
...
from holbydoc.users.forms import (
    RegistrationForm,
    LoginForm,
    UpdateProfileForm,
    RequestResetForm,
...
from holbydoc import bcrypt, db
...
from holbydoc.users.helpers import send_reset_email
