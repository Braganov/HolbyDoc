...
from holbydoc.models import Lesson, Course
from flask import (
    render_template,
    url_for,
    flash,
...
from holbydoc.lessons.forms import (
    NewLessonForm,
    LessonUpdateForm,
)
from holbydoc.courses.forms import NewCourseForm

from holbydoc import db
from flask_modals import render_template_modal
from flask_login import (
    login_required,
    current_user,
)
from holbydoc.helpers import save_picture
from holbydoc.lessons.helpers import get_previous_next_lesson, delete_picture
